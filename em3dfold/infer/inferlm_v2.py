...
def get_args():
    ...
    parser.add_argument(
        "--model-config",
        default=os.path.join(script_dir, "config", "model_v2.yaml"),
        help="Path to the v2 model config yaml",
    )
...
def main(args):
    ...
    run_main(args, model_class, model_args, run_inference_on_data_v2)
